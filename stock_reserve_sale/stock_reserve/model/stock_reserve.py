...
class StockReservation(models.Model):
    ...
    * note
    ...
    def _default_location_id(self):
        ...
        # return (move_obj.with_context(default_picking_type_id=picking_type_id)._default_location_source())
        return (move_obj.with_context(default_picking_type_id=picking_type_id).location_id)
